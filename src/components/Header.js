...
export default function Header() {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            href: "#",
            submenu: [
                { title: "New Launch", href: "/projects/new-launch" },
                { title: "Luxury Projects", href: "/projects/luxury-projects" },
                { title: "Premium Projects", href: "/projects/premium-projects" },
                { title: "Affordable Residential", href: "/projects/affordable-residential" },
                { title: "Residential Under Construction", href: "/projects/residential-under-construction" },
                { title: "Commercial Ready to move-in", href: "/projects/commercial-ready-to-move-in" }
            ]
        },
        {
            title: "Career",
