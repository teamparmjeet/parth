...
const ContactForm = () => {
  ...
  return (
      ...
      <form onSubmit={handleSubmit} className="w-full">
        ...
        <button
          type="submit"
          className="flex w-full text-center  justify-center py-5 px-10 rounded-full  items-center bg-gradient-to-r from-[#DAB221] to-[#B07C0A] text-white font-semibold my-3 leading-3 group  transition"
        >
          Connect Now
        </button>
      </form>
