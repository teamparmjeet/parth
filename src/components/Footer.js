                    ...
                    <div className="grid md:grid-cols-3 gap-5 grid-cols-1">
                        <div className="col-span-1 flex flex-col md:items-start items-center md:text-start text-center">
                            ...
                            <div className="flex items-center  space-x-2">
                                <Link className="h-[25px] inline-block w-[25px] bg-[#CC9B18] rounded-[4px] text-white flex items-center justify-center" href='https://www.facebook.com/parthsarthijaipur'><Facebook size={14} /></Link>
                                <Link className="h-[25px] inline-block w-[25px] bg-[#CC9B18] rounded-[4px] text-white flex items-center justify-center" href='https://www.facebook.com/parthsarthijaipur'><Instagram size={14} /></Link>
                                <Link className="h-[25px] inline-block w-[25px] bg-[#CC9B18] rounded-[4px] text-white flex items-center justify-center" href='https://www.facebook.com/parthsarthijaipur'><Youtube size={14} /></Link>
                                <Link className="h-[25px] inline-block w-[25px] bg-[#CC9B18] rounded-[4px] text-white flex items-center justify-center" href='https://www.facebook.com/parthsarthijaipur'><Linkedin size={14} /></Link>
                        ...
                        <div className="col-span-1 flex flex-col md:items-start items-center md:text-start text-center">
                            ...
                            <form className="relative  mx-auto">
                                ...
                                <button
                                    type="submit"
                                    className="mt-1 w-full bg-yellow-500 text-white py-2 px-4 rounded-md hover:bg-yellow-600 transition duration-300"
                                >
                                    Subscribe
                                </button>
                            </form>
